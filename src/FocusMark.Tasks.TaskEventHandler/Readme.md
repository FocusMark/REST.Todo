...
Execute unit tests
```
    cd "FocusMark.Tasks.TaskEventHandler/test/FocusMark.Tasks.TaskEventHandler.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "FocusMark.Tasks.TaskEventHandler/src/FocusMark.Tasks.TaskEventHandler"
